...
const formSteps = [
  ...
  },
  {
    ...
    inputOptions: { required: 'Selecciona una por favor' },
    options: [
      { value: 'listo', label: 'Ya estoy decidido en invertir, busco el proyecto correcto' },
      { value: 'evaluando', label: 'Estoy comparando bienes raíces contra otras opciones de inversión' },
      { value: 'aprendiendo', label: 'Tengo capital disponible pero aún no defino en qué invertirlo' },
